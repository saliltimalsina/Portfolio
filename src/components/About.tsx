      ...
      <div className="about-inner">
        ...
        <div className="ab-photo-outer" ref={photoRef}>
          ...
          <div className="jojo-cursor" ref={maskRef}>
            <img src="/about/jojo-mask.webp" alt="" loading="lazy" />
          </div>
        </div>
        ...
        <div className="ab-think-grid">
          ...
          <div className="ab-sketch-wrap">
            <img src="/about/sketch.webp" alt="Design thinking illustration" className="ab-sketch-img" loading="lazy" />
          </div>
        </div>
          ...
          <div className="sq-prose">
            <p>
              ...
              <span className="sq-chip">
                <img className="sq-chip-img" src="/sq/hiking.webp" alt="hiking" loading="lazy" />
              </span>{' '}
              ...
              <a href="https://strava.com" className="sq-chip-link sq-strava-pill" target="_blank" rel="noopener noreferrer">
                <img className="sq-chip-img" src="/sq/running.webp" alt="running" loading="lazy" />
            ...
            <p>
              I read{' '}
              <span className="sq-chip">
                <img className="sq-chip-img" src="/sq/vagabond.webp" alt="Vagabond" loading="lazy" />
              </span>{' '}
              ...
              <span className="sq-chip">
                <img className="sq-chip-img" src="/sq/music.webp" alt="music" loading="lazy" />
              </span>{' '}
            ...
            <p>
              Also:{' '}
              <span className="sq-chip">
                <img className="sq-chip-img" src="/sq/ufc.webp" alt="UFC" loading="lazy" />
              </span>{' '}
              <span className="sq-hl sq-hl--red">UFC</span> for reality checks,{' '}
              <span className="sq-chip">
                <img className="sq-chip-img" src="/sq/f1.webp" alt="F1" loading="lazy" />
              </span>{' '}
            ...
            <p>
              And yes —{' '}
              <span className="sq-chip">
                <img className="sq-chip-img" src="/sq/gaming.webp" alt="gaming" loading="lazy" />
              </span>{' '}
          ...
          <div className="bt-stage">
            ...
            <div className="bt-window bt-w2">
              ...
              <div className="bt-body">
                ...
                <img className="bt-thumb" src="/blog-lorem-ipsum.webp" alt="Stop using Lorem Ipsum" loading="lazy" />
